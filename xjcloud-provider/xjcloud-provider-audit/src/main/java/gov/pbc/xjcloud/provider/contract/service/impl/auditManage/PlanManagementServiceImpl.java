...
public class PlanManagementServiceImpl extends IBaseServiceImpl<PlanManagementMapper, PlanCheckList> implements PlanManagementService {
    ...
    @Override
    public List<Map<String, Object>> groupCountProName(String auditYear, String deptId) {
        return planManagementMapper.groupCountProName(auditYear, deptId);
    }
    ...
    @Override
    public List<Map<String, Object>> statisticPlanReportAll(Long pageStart, Long pageNo, String auditYear) {
        return planManagementMapper.statisticPlanReportAll(pageStart, pageNo, auditYear);
    }
