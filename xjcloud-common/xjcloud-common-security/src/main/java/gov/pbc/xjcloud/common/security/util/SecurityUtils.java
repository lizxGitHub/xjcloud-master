package gov.pbc.xjcloud.common.security.util;
...
public class SecurityUtils {
	 ...
	 */
	public XjcloudUser getUser(Authentication authentication) {
		Object principal = authentication.getPrincipal();
		if (principal instanceof XjcloudUser) {
			return (XjcloudUser) principal;
		}
		return null;
	}
